...
int main(int argc, char** argv) {
	char txtFilePath[FILELEN] = "D:/Education/Doctor of Philosophy/Lectures/CMP694_Graph_Theory/Project/kClist/dataset/CA-GrQc.txt";
	char binFilePath[FILELEN] = "D:/Education/Doctor of Philosophy/Lectures/CMP694_Graph_Theory/Project/kClist/dataset/CA-GrQc.bin";
	if (argc < 2) {
		promot();
		//exit(1);
	}
